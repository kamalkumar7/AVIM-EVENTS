  ...
  return (
    <div className="p-8 w-full">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">Job applications submitted via the Careers form. {unread > 0 && <span className="text-amber-400">{unread} unread.</span>}</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left px-5 py-3 text-xs text-gray-500 uppercase tracking-wider">Role</th>
