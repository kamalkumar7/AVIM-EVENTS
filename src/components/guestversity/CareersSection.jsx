      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="reveal-left">
          ...
          <p className="text-white/60 font-inter text-base leading-relaxed mb-5">
            Guestversity Group is where Luxury Hospitality meets Operational
            Excellence. If you&apos;re driven by detail, calm under Pressure,
            and obsessed with Premium Experiences — your next chapter starts here.
          </p>
          <p className="text-white/60 font-inter text-base leading-relaxed mb-8">
            Work Alongside teams that execute Royal Weddings, High‑Profile
            Corporate Events, and large‑scale Guest movement with Composure,
            Precision, and Class.
          </p>

          <blockquote className="font-fraunces text-xl text-gradient-gold italic mb-10">
            &ldquo;Where Hospitality Meets Opportunity.&rdquo;
          </blockquote>
          ...
          <ul className="space-y-4 mb-10">
            {benefits.map((b, i) => (
              <li key={i} className="flex items-start gap-3">
                ...
                />
                <span className="text-white/70 font-inter text-sm leading-relaxed">
                  {b}
                </span>
              </li>
            ))}
          ...
          <p className="text-white/40 font-inter text-xs italic">
            We hire for Hospitality, Logistics Ops, Guest Coordination, Event
            Execution, and Field Leadership.
          </p>
        </div>

        {/* Right — Visual block + form */}
        <div className="reveal-right space-y-6">
          {/* Creative visual card */}
          <div className="glass-card-gv relative overflow-hidden p-7">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-gv-gold font-inter text-[9px] tracking-[0.2em] uppercase font-semibold border border-gv-gold/30 rounded-full px-3 py-1">
                  CAREERS AT GUESTVERSITY
                </span>
                <span className="text-white/30 font-inter text-[9px] tracking-[0.2em] uppercase">
                  PREMIUM TEAM
                </span>
              </div>

              <h3 className="font-fraunces text-lg text-white/90 mb-2">
                SIGNATURE CULTURE
              </h3>
              <p className="font-fraunces text-xl text-white mb-4">
                Shape Experiences.{" "}
                <span className="text-gradient-gold">Elevate Standards.</span>
              </p>
              <p className="text-white/50 font-inter text-sm leading-relaxed mb-6">
                A calm Luxury Surface — Powered by Sharp Systems, Disciplined
                Teams, and High‑Touch Hospitality.
              </p>
              ...
              <div className="rounded-xl overflow-hidden" style={{ height: "180px" }}>
                <img
                  src="/images/guestversity/careers/career-1.jpg"
                  alt="Guestversity team at a premium event"
            ...
            <div
              className="absolute bottom-4 right-4 w-10 h-10 border border-gv-gold/30 rounded-sm pointer-events-none"
              style={{ transform: "rotate(15deg)" }}
            />
            <div
              className="absolute top-14 right-6 w-6 h-6 border border-gv-gold/20 rounded-full pointer-events-none"
            />
          </div>
          ...
          <div className="glass-card-gv p-7">
            ...
            <p className="text-white/45 font-inter text-sm mb-6">
              A minimal application — premium, private, and fast.
            </p>
            ...
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-white/60 font-inter text-sm">
                  ...
                  <a
                    href="mailto:careers@guestversitygroup.com"
                    className="text-gv-gold underline underline-offset-2"
                  >
                    careers@guestversitygroup.com
                  </a>
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="gold-btn glow-pulse w-full py-3.5 text-center text-sm"
                >
                  Submit Application
                </button>
                <p className="text-white/25 font-inter text-[11px] text-center">
                  By applying, you consent to be contacted for recruitment purposes.
                </p>
              </form>
            )}

            <div className="border-t border-white/[0.06] mt-6 pt-5 text-center space-y-1">
              <p className="text-white/25 font-inter text-[10px] tracking-widest uppercase">
                Premium hiring &nbsp;•&nbsp; High standards &nbsp;•&nbsp; Calm execution
              </p>
              <p className="text-gv-gold font-inter text-[10px] tracking-[0.2em] uppercase font-semibold">
                GUESTVERSITY GROUP
              </p>
            </div>
          </div>
